...
def main():
    ...
    try:
        ...
        # Remap top-level experience key (DeepSeek sometimes uses work_experience)
        ...
        # Remap top-level linkedin/github/portfolio into nested links object
        ...
        # Remap education date fields if DeepSeek used different names
        ...
        # Replace empty strings or None with "NA"
